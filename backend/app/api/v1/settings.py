...
async def update_system_settings(
    ...
    if req.firebase_service_account_json is not None:
        ...
        # Also auto-extract project_id if present in JSON
        if '"project_id"' in req.firebase_service_account_json:
            ...
            try:
                ...
                pass
    if req.firebase_storage_bucket is not None:
        settings.FIREBASE_STORAGE_BUCKET = req.firebase_storage_bucket
    if req.firebase_messaging_sender_id is not None:
        settings.FIREBASE_MESSAGING_SENDER_ID = req.firebase_messaging_sender_id
